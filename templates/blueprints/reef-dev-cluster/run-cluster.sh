...
TEMPLATE_ASSET_REF="${TEMPLATE_ASSET_REF:-master}"
TEMPLATE_ASSET_BASE_URL="${TEMPLATE_ASSET_BASE_URL:-https://raw.githubusercontent.com/skygenesisenterprise/notploy/${TEMPLATE_ASSET_REF}/templates/blueprints/reef-dev-cluster}"
