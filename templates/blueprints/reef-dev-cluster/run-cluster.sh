...
TEMPLATE_ASSET_BASE_URL="${TEMPLATE_ASSET_BASE_URL:-https://raw.githubusercontent.com/anukulpandey/notploy-templates/${TEMPLATE_ASSET_REF}/blueprints/reef-dev-cluster}"
