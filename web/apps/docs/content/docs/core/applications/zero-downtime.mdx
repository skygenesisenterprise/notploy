...
1. We will use this example [Github Repo](https://github.com/Notploy/swarm-test)
2. It Have a endpoint called `health` [endpoint](https://github.com/Notploy/swarm-test/blob/main/index.js#L20) which is the one that will tell us if our application is healthy.
...
1. **Use Git Provider in Your Application**:
   - Repository: `https://github.com/Notploy/swarm-test`
   - Branch: `main`
   - Build path: `/`
