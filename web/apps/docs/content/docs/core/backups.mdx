---
title: Backups
description: 'Learn how to create and restore backups of your Notploy applications and services.'
---

import { Callout } from 'fumadocs-ui/components/callout';

Notploy provides a comprehensive backup and restore system that saves your entire Notploy file system and database to ensure your data is safe and recoverable.
...
When a backup is created, Notploy will:
- Back up the PostgreSQL database (`notploy-postgres`)
- Save the Notploy file system (`/etc/notploy`)
...
During restoration, Notploy will:
- Clear the existing `/etc/notploy` directory and replace it with the backup contents
- Drop the existing `notploy-postgres` database
