---
title: Databases
description: "Discover how to create and backup databases easily with Notploy, supporting a variety of database systems."
---

Notploy simplifies the process of creating and managing databases, offering robust options for both setup and backups.

## Database Support

Notploy currently supports a range of popular database systems, ensuring compatibility and flexibility for your projects:
