---
title: 'Features'
description: 'Explore the comprehensive suite of features available in Notploy for optimized application deployment and management.'
---

Notploy provides a comprehensive suite of features designed to simplify and enhance the application deployment process.

## Application Deployment

Notploy supports two primary methods for deploying applications:
...
These features are designed to offer flexibility and control over your deployment environments, ensuring that Notploy meets the diverse needs of modern application deployment and management.
