...
Manage user roles and permissions within Notploy. Notploy handles three distinct roles with different levels of access and capabilities.

## Roles

Notploy supports three roles for managing user access:
