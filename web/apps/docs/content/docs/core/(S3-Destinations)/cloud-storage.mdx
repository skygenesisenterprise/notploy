...
5. Copy the value in `Storage URI`. You will need this for the Endpoint value in Notploy.
...
| (from) Cloud Storage | (to) Notploy        | Example value                                                        |
|---------------------|---------------------|---------------------------------------------------------------------|
...
| `Bucket Name`       | `Bucket`            | `notploy-backups` use the name of the bucket you created.            |
