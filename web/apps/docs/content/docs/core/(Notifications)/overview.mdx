...
Notploy offers multiple notification options to notify you about important events in your applications and services.
...
6. **Notploy Restart**: Trigger the action when Notploy is restarted.

## Providers

Notploy supports the following notification providers:
