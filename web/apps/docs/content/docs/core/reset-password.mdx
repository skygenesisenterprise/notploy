...
description: "Reset your password to access your Notploy account and disable 2FA."
---
...
Run the command below to get the container ID of the notploy container.
...
Run command below to open a shell in the notploy container.
```bash
