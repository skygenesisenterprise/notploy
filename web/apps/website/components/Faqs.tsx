...
const faqs = [
	{
		...
		answer:
			"Notploy is a stable, easy-to-use deployment solution designed to simplify the application management process. Think of Notploy as a free alternative self-hostable solution to platforms like Heroku, Vercel, and Netlify.",
	},
	{
		question: "How does Notploy's Open Source plan work?",
		answer:
			"You can host Notploy UI on your own infrastructure and you will be responsible for the maintenance and updates.",
	},
	{
		question: "Do I need to provide my own server for the managed plan?",
		answer:
			"Yes, in the managed plan, you provide your own server (e.g., Hetzner, Hostinger, AWS, etc.) VPS, and we manage the Notploy UI infrastructure for you.",
	},
	{
	...
	{
		question: "Why Choose Notploy?",
		answer:
			"Notploy offers simplicity, flexibility, and speed in application deployment and management.",
	},
	{
		question: "Is it open source?",
		answer: "Yes, Notploy offers a plan that is open source and free to use.",
	},
	{
		question: "Can I use Notploy to deploy AI-built apps?",
		answer:
			"Yes. Notploy works with code from any source, including apps built with AI coding tools. You can deploy using your existing Git, Docker, and Compose workflows, or create a sandbox environment to give teams a governed space where they can ship AI-built apps with SSO, audit logs, and multitenancy built in.",
	},
	{
		question: "What types of languages can I deploy with Notploy?",
		answer:
			"Notploy does not restrict programming languages. You are free to choose your preferred language and framework.",
	},
	{
	...
	{
		question: "Do you track the usage of Notploy?",
	...
	{
		question: "What types of applications can I deploy with Notploy?",
		answer:
			"You can deploy any application that can be Dockerized, with no limits. Notploy supports builds from Git repositories, Dockerfiles, Nixpacks, and Buildpacks like Heroku and Paketo.",
	},
	{
		question: "How does Notploy handle database management?",
		answer:
			"Notploy supports multiple database systems including Postgres, MySQL, MariaDB, MongoDB, and Redis, providing tools for easy deployment and management and backups directly from the dashboard.",
	},
];
