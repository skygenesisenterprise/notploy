...
export const notifications = pgTable("notification", {
	...
	notployRestart: boolean("notployRestart").notNull().default(false),
	notployBackup: boolean("notployBackup").notNull().default(false),
...
export const apiUpdatePushover = z.object({
	...
	notployBackup: z.boolean().optional(),
	volumeBackup: z.boolean().optional(),
	notployRestart: z.boolean().optional(),
