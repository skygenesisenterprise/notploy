...
export const generatedTools = [
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean(), "databaseBackup": z.boolean(), "notployBackup": z.boolean(), "volumeBackup": z.boolean(), "notployRestart": z.boolean(), "name": z.string(), "appDeploy": z.boolean(), "dockerCleanup": z.boolean(), "serverThreshold": z.boolean(), "webhookUrl": z.string().min(1), "channel": z.string() }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean(), "databaseBackup": z.boolean(), "notployBackup": z.boolean(), "volumeBackup": z.boolean(), "notployRestart": z.boolean(), "name": z.string(), "appDeploy": z.boolean(), "dockerCleanup": z.boolean(), "serverThreshold": z.boolean(), "botToken": z.string().min(1), "chatId": z.string().min(1), "messageThreadId": z.string() }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean(), "databaseBackup": z.boolean(), "notployBackup": z.boolean(), "volumeBackup": z.boolean(), "notployRestart": z.boolean(), "name": z.string(), "appDeploy": z.boolean(), "dockerCleanup": z.boolean(), "serverThreshold": z.boolean(), "webhookUrl": z.string().min(1), "decoration": z.boolean() }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean(), "databaseBackup": z.boolean(), "notployBackup": z.boolean(), "volumeBackup": z.boolean(), "notployRestart": z.boolean(), "name": z.string(), "appDeploy": z.boolean(), "dockerCleanup": z.boolean(), "serverThreshold": z.boolean(), "smtpServer": z.string().min(1), "smtpPort": z.number().gte(1), "username": z.string().min(1), "password": z.string().min(1), "fromAddress": z.string().min(1), "toAddresses": z.array(z.string()).min(1) }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean(), "databaseBackup": z.boolean(), "notployBackup": z.boolean(), "volumeBackup": z.boolean(), "notployRestart": z.boolean(), "name": z.string(), "appDeploy": z.boolean(), "dockerCleanup": z.boolean(), "serverThreshold": z.boolean(), "apiKey": z.string().min(1), "fromAddress": z.string().min(1), "toAddresses": z.array(z.string()).min(1) }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "ServerType": z.enum(["Notploy", "Remote"]).default("Notploy"), "Type": z.enum(["Memory", "CPU"]), "Value": z.number(), "Threshold": z.number(), "Message": z.string(), "Timestamp": z.string(), "Token": z.string() }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean(), "databaseBackup": z.boolean(), "notployBackup": z.boolean(), "volumeBackup": z.boolean(), "notployRestart": z.boolean(), "name": z.string(), "appDeploy": z.boolean(), "dockerCleanup": z.boolean(), "serverThreshold": z.boolean(), "serverUrl": z.string().min(1), "appToken": z.string().min(1), "priority": z.number().gte(1), "decoration": z.boolean() }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean(), "databaseBackup": z.boolean(), "notployBackup": z.boolean(), "volumeBackup": z.boolean(), "notployRestart": z.boolean(), "name": z.string(), "appDeploy": z.boolean(), "dockerCleanup": z.boolean(), "serverThreshold": z.boolean(), "serverUrl": z.string().min(1), "topic": z.string().min(1), "accessToken": z.string(), "priority": z.number().gte(1) }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean(), "databaseBackup": z.boolean(), "notployBackup": z.boolean(), "volumeBackup": z.boolean(), "notployRestart": z.boolean(), "name": z.string(), "appDeploy": z.boolean(), "dockerCleanup": z.boolean(), "serverThreshold": z.boolean(), "webhookUrl": z.string().url(), "channel": z.string().optional(), "username": z.string().optional() }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean().optional(), "databaseBackup": z.boolean().optional(), "notployBackup": z.boolean().optional(), "volumeBackup": z.boolean().optional(), "notployRestart": z.boolean().optional(), "name": z.string(), "appDeploy": z.boolean().optional(), "dockerCleanup": z.boolean().optional(), "serverThreshold": z.boolean().optional(), "endpoint": z.string().min(1), "headers": z.record(z.string()).optional() }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean(), "databaseBackup": z.boolean(), "notployBackup": z.boolean(), "volumeBackup": z.boolean(), "notployRestart": z.boolean(), "name": z.string(), "appDeploy": z.boolean(), "dockerCleanup": z.boolean(), "serverThreshold": z.boolean(), "webhookUrl": z.string().min(1) }),
        annotations: {
    ...
    },
    {
        ...
        schema: z.object({ "appBuildError": z.boolean().optional(), "databaseBackup": z.boolean().optional(), "notployBackup": z.boolean().optional(), "volumeBackup": z.boolean().optional(), "notployRestart": z.boolean().optional(), "name": z.string(), "appDeploy": z.boolean().optional(), "dockerCleanup": z.boolean().optional(), "serverThreshold": z.boolean().optional(), "userKey": z.string().min(1), "apiToken": z.string().min(1), "priority": z.number().gte(-2).lte(2).default(0), "retry": z.union([z.number().gte(30), z.null()]).optional(), "expire": z.union([z.number().gte(1).lte(10800), z.null()]).optional() }),
        annotations: {
    ...
    {
        name: "settings-getNotployVersion",
        description: "GET /settings.getNotployVersion",
        tag: "settings",
        method: "GET",
        path: "/settings.getNotployVersion",
        schema: z.object({}),
        annotations: {
            title: "Settings GetNotployVersion",
            ...{ "readOnlyHint": true, "idempotentHint": true, "openWorldHint": true },
        },
    },
    {
    ...
    {
        name: "settings-getNotployCloudIps",
        description: "GET /settings.getNotployCloudIps",
        tag: "settings",
        method: "GET",
        path: "/settings.getNotployCloudIps",
        schema: z.object({}),
        annotations: {
            title: "Settings GetNotployCloudIps",
            ...{ "readOnlyHint": true, "idempotentHint": true, "openWorldHint": true },
        },
    },
    {
    ...
    },
    {
        ...
        schema: z.object({ "scheduleId": z.string().optional(), "name": z.string(), "description": z.union([z.string(), z.null()]).optional(), "cronExpression": z.string(), "appName": z.string().optional(), "serviceName": z.union([z.string(), z.null()]).optional(), "shellType": z.enum(["bash", "sh"]).optional(), "scheduleType": z.enum(["application", "compose", "server", "notploy-server"]).optional(), "command": z.string(), "script": z.union([z.string(), z.null()]).optional(), "applicationId": z.union([z.string(), z.null()]).optional(), "composeId": z.union([z.string(), z.null()]).optional(), "serverId": z.union([z.string(), z.null()]).optional(), "organizationId": z.union([z.string(), z.null()]).optional(), "enabled": z.boolean().optional(), "timezone": z.union([z.string(), z.null()]).optional(), "createdAt": z.string().optional() }),
        annotations: {
    ...
    },
    {
        ...
        method: "GET",
        path: "/schedule.list",
        schema: z.object({ "id": z.string(), "scheduleType": z.enum(["application", "compose", "server", "notploy-server"]) }),
        annotations: {
            title: "Schedule List",
            ...{ "readOnlyHint": true, "idempotentHint": true, "openWorldHint": true },
        },
