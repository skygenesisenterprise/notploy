import type {
	OverviewServiceType,
	OverviewSortBy,
} from "@notploy/server/services/overview-shared";
import { sortOverviewServices } from "@notploy/server/services/overview-shared";
import {
	Ban,
	CircuitBoard,
	GlobeIcon,
		...
		const filtered = services.filter(
			(service) =>
				...
				(selectedServerId === "all" ||
					(selectedServerId === "notploy-server" && !service.serverId) ||
							...
							>
								...
								<SelectContent>
									...
									{hasServicesWithoutServer && (
										<SelectItem value="notploy-server">
											Notploy server
										</SelectItem>
									)}
											...
											<TableCell>
												<div className="flex items-center gap-1.5 text-muted-foreground">
													...
													<span className="truncate">
														{service.serverName ?? "Notploy server"}
													</span>
												</div>
											</TableCell>
											<TableCell>
